    ...
    <>
      <section style={{ paddingTop: 140, paddingBottom: 64, background: "var(--color-bg)", borderBottom: "1px solid var(--color-border)" }}>
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 24px" }}>
          <motion.p style={{ color: "#4ade80", fontSize: 12, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 20 }}
          ...
          <motion.h1 style={{ fontFamily: "var(--font-display, Outfit, sans-serif)", fontSize: "clamp(36px, 5.5vw, 80px)", fontWeight: 800, letterSpacing: "-0.04em", lineHeight: 1, marginBottom: 20 }}
            ...
            Votre candidature<br /><span style={{ color: "#4ade80" }}>spontanée.</span>
          </motion.h1>
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "1fr 380px", gap: 64, alignItems: "start" }} className="contact-grid">
          <div>
            {submitted ? (
              <motion.div style={{ background: "rgba(34,197,94,0.06)", border: "1px solid rgba(34,197,94,0.3)", borderRadius: 16, padding: "48px 40px", textAlign: "center" }}
                ...
                <div style={{ width: 52, height: 52, borderRadius: "50%", background: "rgba(34,197,94,0.15)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 24px", color: "#4ade80", fontSize: 22 }}>✓</div>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                ...
                <button type="submit"
                  style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#16a34a", color: "#fff", padding: "16px 28px", borderRadius: 10, fontSize: 15, fontWeight: 700, border: "none", cursor: "pointer", alignSelf: "flex-start" }}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div style={{ padding: "28px 24px", borderRadius: 14, border: "1px solid rgba(34,197,94,0.2)", background: "rgba(34,197,94,0.04)" }}>
              ...
              <p style={{ color: "#4ade80", fontSize: 12, fontWeight: 600, marginBottom: 16 }}>Directrice des Ressources Humaines</p>
            ...
            {[
              ...
              <div key={item.label} style={{ display: "flex", gap: 14, padding: "20px 20px", borderRadius: 12, border: "1px solid var(--color-border)", background: "var(--color-bg-2)", alignItems: "center" }}>
                <div style={{ width: 38, height: 38, borderRadius: 9, background: "rgba(34,197,94,0.1)", color: "#4ade80", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>{item.icon}</div>
                <div>
